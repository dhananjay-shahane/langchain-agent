...
def create_depth_plot(filename: str, curve_name: str = "POROSITY") -> str:
    ...
    try:
        ...
        curve_data = np.clip(curve_data, 0.08, 0.24)  # Realistic porosity range
        ...
        return f"Plot saved as {output_filename}. Shows {curve_name} data vs depth for well log {filename}."
...
def create_formation_analysis(filename: str) -> str:
    ...
    try:
        ...
        formations = [
            {"name": "Sandstone Layer", "top_depth": 2450, "bottom_depth": 2650, "porosity_avg": 18.5},
            {"name": "Shale Formation", "top_depth": 2650, "bottom_depth": 2850, "porosity_avg": 8.2},
            {"name": "Limestone Unit", "top_depth": 2850, "bottom_depth": 3050, "porosity_avg": 22.1},
            {"name": "Tight Sand", "top_depth": 3050, "bottom_depth": 3200, "porosity_avg": 12.7}
        ]
        ...
        for formation in formations:
            ...
            analysis.append(f"  Depth: {formation['top_depth']} - {formation['bottom_depth']} ft")
